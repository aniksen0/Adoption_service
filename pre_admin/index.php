            ...
            <ul class="nav">
                <li class="nav-item active  ">
                    <a class="nav-link" href="index.php">
                        <i class="material-icons">Pre admin dashboard</i>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-footer">
                                <div class="stats">
                                    <i class="material-icons">update</i> <?php $t=time(); echo(date("Y-m-d",$t)); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-chart">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-category">
                                    <span class="text-success"><i class="fa fa-long-arrow-up"></i> <?php echo $number ?></span> increase in today data.</p>
                            </div>
                            <div class="card-footer">
                                <div class="stats">
