...
<!--                   <a href="syslog.php"><button class="btn btn-info">Search Again</button></a>-->
<!--                    <ul class="navbar-nav">-->
<!--                        <li class="nav-item">-->
...
<!--                        </div>-->
<!--                    </div>-->
<!--                        --><?php //unset($_SESSION['to']);?>
<!--                        --><?php //unset($_SESSION['from']);?>
<!--                    <footer id="footer d-flex">-->
<!--                        <p class="d-flex text-center">&copyright All rights reserved</p>-->
<!--                    </footer>-->
<!--                </div>-->
<!--            </div>-->
<!---->
